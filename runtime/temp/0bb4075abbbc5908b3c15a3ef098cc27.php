<?php /*a:1:{s:58:"D:\Timount\mall\application\goods\view\topgoods\index.html";i:1547688907;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <!-- 下面是定义标签库 -->
    ...
    layui.use(['table','form'], function() {
        ...
        tableIn = table.render({
            ...
            cols: [[
                ...
                {field: 'create_time', title: '商品创建时间',align: 'center', width: 180,templet: '#media_name'},
        ...
        table.on('tool(list)', function(obj) {
            ...
            if (obj.event === 'del'){
                layer.confirm('您确定要操作该商品吗？', function(index){
                    ...
                    $.post("<?php echo url('del'); ?>",{id:data.top_id,type:data.top_status},function(res){
                        layer.close(loading);
                        if(res.code===1){
