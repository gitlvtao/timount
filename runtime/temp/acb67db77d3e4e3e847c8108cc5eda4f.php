<?php /*a:1:{s:58:"D:\Timount\mall\application\userdata\view\goods\index.html";i:1549959944;}*/ ?>
<!DOCTYPE html>
    ...
    layui.config({
        ...
        tableIn = function(dateTime,media_id){
            ...
            treetable.render({
                ...
                // page:true,
                cols: [[
                    {field: 'name', title: '商品ID',align: 'center', width: 300,templet: '#media_balance'},
                    {field: 'PV', title: 'PV',align: 'center', width: 100,templet: '#media_balance'},
                    {field: 'UV', title: 'UV',align: 'center', width: 100,templet: '#media_balance'},
                    {field: 'time', title: '平均停留时长',align: 'center', width: 150,templet: '#media_balance'},
                    {field: 'copy_pv', title: '一键复制点击pv',align: 'center', width: 150,templet: '#media_balance'},
                    {field: 'copy_uv', title: '一键复制点击uv',align: 'center', width: 150,templet: '#media_balance'},
                    {field: 'ticket_pv', title: '领券购买点击pv',align: 'center', width: 150,templet: '#media_balance'},
                    {field: 'ticket_uv', title: '领券购买点击uv',align: 'center', width: 150,templet: '#media_balance'},
                    {field: 'share_pv', title: '分享点击pv',align: 'center', width: 150,templet: '#media_balance'},
                    {field: 'share_uv', title: '分享点击uv',align: 'center', width: 150,templet: '#media_balance'},
                    {field: 'buy_pv', title: '不领券购买点击pv',align: 'center', width: 150,templet: '#media_balance'},
                    {field: 'buy_uv', title: '不领券购买点击uv',align: 'center', width: 150,templet: '#media_balance'}
                ]]
            });
        };
